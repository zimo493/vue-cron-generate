...
export default await (async () => {
    ...
    function __VLS_template() {
        ...
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ value: ((__VLS_ctx.radioValue)), name: ("selectHour"), }));
        const __VLS_8 = __VLS_7({ value: ((__VLS_ctx.radioValue)), name: ("selectHour"), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
        ({}({ value: ((__VLS_ctx.radioValue)), name: ("selectHour"), }));
        // @ts-ignore
        const __VLS_12 = {}
            .NGrid;
        ({}.NGrid);
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_55 = __VLS_asFunctionalComponent(__VLS_54, new __VLS_54({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle01)), min: ((0)), max: ((22)), clearable: (true), }));
        const __VLS_56 = __VLS_55({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle01)), min: ((0)), max: ((22)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_55));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle01)), min: ((0)), max: ((22)), clearable: (true), }));
        let __VLS_60;
        const __VLS_61 = {
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_64 = __VLS_asFunctionalComponent(__VLS_63, new __VLS_63({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle02)), min: ((__VLS_ctx.cycle01 ? __VLS_ctx.cycle01 + 1 : 1)), max: ((23)), clearable: (true), }));
        const __VLS_65 = __VLS_64({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle02)), min: ((__VLS_ctx.cycle01 ? __VLS_ctx.cycle01 + 1 : 1)), max: ((23)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_64));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle02)), min: ((__VLS_ctx.cycle01 ? __VLS_ctx.cycle01 + 1 : 1)), max: ((23)), clearable: (true), }));
        let __VLS_69;
        const __VLS_70 = {
            'onUpdate:value': (...[$event]) => {
                __VLS_ctx.radioChange(2);
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_91 = __VLS_asFunctionalComponent(__VLS_90, new __VLS_90({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average01)), min: ((0)), max: ((22)), clearable: (true), }));
        const __VLS_92 = __VLS_91({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average01)), min: ((0)), max: ((22)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_91));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average01)), min: ((0)), max: ((22)), clearable: (true), }));
        let __VLS_96;
        const __VLS_97 = {
            'onUpdate:value': (...[$event]) => {
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_100 = __VLS_asFunctionalComponent(__VLS_99, new __VLS_99({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average02)), min: ((1)), max: ((23 - __VLS_ctx.average01 || 0)), clearable: (true), }));
        const __VLS_101 = __VLS_100({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average02)), min: ((1)), max: ((23 - __VLS_ctx.average01 || 0)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_100));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average02)), min: ((1)), max: ((23 - __VLS_ctx.average01 || 0)), clearable: (true), }));
        let __VLS_105;
        const __VLS_106 = {
            'onUpdate:value': (...[$event]) => {
                __VLS_ctx.radioChange(3);
        ...
        [NFlex, NFlex,];
        // @ts-ignore
        const __VLS_135 = __VLS_asFunctionalComponent(__VLS_134, new __VLS_134({ vertical: (true), }));
        const __VLS_136 = __VLS_135({ vertical: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_135));
        ({}({ vertical: (true), }));
        ...
        [NSpace, NSpace,];
        // @ts-ignore
        const __VLS_141 = __VLS_asFunctionalComponent(__VLS_140, new __VLS_140({ inline: (true), }));
        const __VLS_142 = __VLS_141({ inline: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_141));
        ({}({ inline: (true), }));
        for (const [item] of __VLS_getVForSourceType((12))) {
            // @ts-ignore
            const __VLS_146 = {}
                .NCheckbox;
            ({}.NCheckbox);
            ...
            [NCheckbox,];
            // @ts-ignore
            const __VLS_147 = __VLS_asFunctionalComponent(__VLS_146, new __VLS_146({ key: ((item)), value: ((item - 1)), label: ((__VLS_ctx.zeroFill(item - 1))), }));
            const __VLS_148 = __VLS_147({ key: ((item)), value: ((item - 1)), label: ((__VLS_ctx.zeroFill(item - 1))), }, ...__VLS_functionalComponentArgsRest(__VLS_147));
        ...
        [NSpace, NSpace,];
        // @ts-ignore
        const __VLS_153 = __VLS_asFunctionalComponent(__VLS_152, new __VLS_152({ inline: (true), }));
        const __VLS_154 = __VLS_153({ inline: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_153));
        ({}({ inline: (true), }));
        for (const [item] of __VLS_getVForSourceType((12))) {
            // @ts-ignore
            const __VLS_158 = {}
            ...
            [NCheckbox,];
            // @ts-ignore
            const __VLS_159 = __VLS_asFunctionalComponent(__VLS_158, new __VLS_158({ key: ((item)), value: ((item + 11)), label: ((__VLS_ctx.zeroFill(item + 11))), }));
            const __VLS_160 = __VLS_159({ key: ((item)), value: ((item + 11)), label: ((__VLS_ctx.zeroFill(item + 11))), }, ...__VLS_functionalComponentArgsRest(__VLS_159));
            ({}({ key: ((item)), value: ((item + 11)), label: ((__VLS_ctx.zeroFill(item + 11))), }));
            // @ts-ignore
            [zeroFill,];
