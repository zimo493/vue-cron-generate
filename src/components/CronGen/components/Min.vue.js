...
export default await (async () => {
    ...
    function __VLS_template() {
        ...
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ value: ((__VLS_ctx.radioValue)), name: ("selectMin"), }));
        const __VLS_8 = __VLS_7({ value: ((__VLS_ctx.radioValue)), name: ("selectMin"), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
        ({}({ value: ((__VLS_ctx.radioValue)), name: ("selectMin"), }));
        // @ts-ignore
        const __VLS_12 = {}
            .NGrid;
        ({}.NGrid);
