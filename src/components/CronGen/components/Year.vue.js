...
export default await (async () => {
    ...
    const cycle02 = ref(cycle01.value + 1);
    ...
    function __VLS_template() {
        ...
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ value: ((__VLS_ctx.radioValue)), name: ("selectYear"), }));
        const __VLS_8 = __VLS_7({ value: ((__VLS_ctx.radioValue)), name: ("selectYear"), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
        ({}({ value: ((__VLS_ctx.radioValue)), name: ("selectYear"), }));
        // @ts-ignore
        const __VLS_12 = {}
            .NGrid;
        ({}.NGrid);
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_73 = __VLS_asFunctionalComponent(__VLS_72, new __VLS_72({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle01)), min: ((__VLS_ctx.fullYear)), max: ((2098)), clearable: (true), }));
        const __VLS_74 = __VLS_73({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle01)), min: ((__VLS_ctx.fullYear)), max: ((2098)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_73));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle01)), min: ((__VLS_ctx.fullYear)), max: ((2098)), clearable: (true), }));
        let __VLS_78;
        const __VLS_79 = {
            'onUpdate:value': (...[$event]) => {
                __VLS_ctx.radioChange(3);
                // @ts-ignore
                [cycle01, fullYear, radioChange,];
            }
        };
        const __VLS_80 = {
            onFocus: (...[$event]) => {
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_82 = __VLS_asFunctionalComponent(__VLS_81, new __VLS_81({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle02)), min: ((__VLS_ctx.cycle01 ? __VLS_ctx.cycle01 + 1 : __VLS_ctx.fullYear + 1)), max: ((2099)), clearable: (true), }));
        const __VLS_83 = __VLS_82({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle02)), min: ((__VLS_ctx.cycle01 ? __VLS_ctx.cycle01 + 1 : __VLS_ctx.fullYear + 1)), max: ((2099)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_82));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.cycle02)), min: ((__VLS_ctx.cycle01 ? __VLS_ctx.cycle01 + 1 : __VLS_ctx.fullYear + 1)), max: ((2099)), clearable: (true), }));
        let __VLS_87;
        const __VLS_88 = {
            'onUpdate:value': (...[$event]) => {
                __VLS_ctx.radioChange(3);
                // @ts-ignore
                [cycle01, cycle01, fullYear, radioChange, cycle02,];
            }
        };
        const __VLS_89 = {
            onFocus: (...[$event]) => {
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_109 = __VLS_asFunctionalComponent(__VLS_108, new __VLS_108({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average01)), min: ((__VLS_ctx.fullYear)), max: ((2098)), clearable: (true), }));
        const __VLS_110 = __VLS_109({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average01)), min: ((__VLS_ctx.fullYear)), max: ((2098)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_109));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average01)), min: ((__VLS_ctx.fullYear)), max: ((2098)), clearable: (true), }));
        let __VLS_114;
        const __VLS_115 = {
            'onUpdate:value': (...[$event]) => {
                __VLS_ctx.radioChange(4);
                // @ts-ignore
                [fullYear, radioChange, average01,];
            }
        };
        const __VLS_116 = {
            onFocus: (...[$event]) => {
        ...
        [NInputNumber,];
        // @ts-ignore
        const __VLS_118 = __VLS_asFunctionalComponent(__VLS_117, new __VLS_117({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average02)), min: ((1)), max: ((2099 - __VLS_ctx.average01 || __VLS_ctx.fullYear)), clearable: (true), }));
        const __VLS_119 = __VLS_118({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average02)), min: ((1)), max: ((2099 - __VLS_ctx.average01 || __VLS_ctx.fullYear)), clearable: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_118));
        ({}({ ...{ 'onUpdate:value': {} }, ...{ 'onFocus': {} }, value: ((__VLS_ctx.average02)), min: ((1)), max: ((2099 - __VLS_ctx.average01 || __VLS_ctx.fullYear)), clearable: (true), }));
        let __VLS_123;
        const __VLS_124 = {
            'onUpdate:value': (...[$event]) => {
                __VLS_ctx.radioChange(4);
                // @ts-ignore
                [fullYear, radioChange, average01, average02,];
            }
        };
        const __VLS_125 = {
            onFocus: (...[$event]) => {
        ...
        [NRadio,];
        // @ts-ignore
        const __VLS_139 = __VLS_asFunctionalComponent(__VLS_138, new __VLS_138({ value: ((6)), }));
        const __VLS_140 = __VLS_139({ value: ((6)), }, ...__VLS_functionalComponentArgsRest(__VLS_139));
        ({}({ value: ((6)), }));
        ...
        // @ts-ignore
        const __VLS_145 = __VLS_asFunctionalComponent(__VLS_144, new __VLS_144({ ...{ 'onUpdate:value': {} }, value: ((__VLS_ctx.checkboxList)), }));
        const __VLS_146 = __VLS_145({ ...{ 'onUpdate:value': {} }, value: ((__VLS_ctx.checkboxList)), }, ...__VLS_functionalComponentArgsRest(__VLS_145));
        ...
        ({}({}));
        for (const [item] of __VLS_getVForSourceType((11))) {
            // @ts-ignore
            const __VLS_158 = {}
                .NCheckbox;
            ({}.NCheckbox);
            ...
            [NCheckbox,];
            // @ts-ignore
            const __VLS_159 = __VLS_asFunctionalComponent(__VLS_158, new __VLS_158({ key: ((item)), value: ((item - 1 + __VLS_ctx.fullYear)), label: ((String(item - 1 + __VLS_ctx.fullYear))), }));
            const __VLS_160 = __VLS_159({ key: ((item)), value: ((item - 1 + __VLS_ctx.fullYear)), label: ((String(item - 1 + __VLS_ctx.fullYear))), }, ...__VLS_functionalComponentArgsRest(__VLS_159));
            ({}({ key: ((item)), value: ((item - 1 + __VLS_ctx.fullYear)), label: ((String(item - 1 + __VLS_ctx.fullYear))), }));
            // @ts-ignore
            [fullYear, fullYear,];
